            ...
            val task = project.tasks.register<TelegramStringsTask>(
                ...
                stringsXml.from(
                    telegramModule.fileTree("src/main/res/values") {
                        include("strings.xml", "strings_na.xml", "strings_nax.xml", "strings_naxf.xml", "strings_neko.xml")
                    },
                ...
                localizationFiles.from(
                    telegramModule.fileTree("src/main/res") {
                        include("values-*/strings.xml", "values-*/strings_na.xml", "values-*/strings_nax.xml", "values-*/strings_naxf.xml", "values-*/strings_neko.xml")
                    },
