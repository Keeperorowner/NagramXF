...
abstract class TelegramStringsTask : DefaultTask() {
    ...
    companion object {
        private val GENERATED_EXCLUSIONS = setOf(
            "AppName",
            "AppNameBeta",
            // fork keys referenced from xml/manifest or resolved by name at runtime
            // (getIdentifier), so they must stay in resources.arsc:
            "SettingsNax",
            "AccountSettingsNax",
            "ChatHistory_LinkSharedToChat_one",
            "ChatHistory_LinkSharedToChat_other",
            "ChatHistory_ChatsRemoved_one",
            "ChatHistory_ChatsRemoved_few",
            "ChatHistory_ChatsRemoved_many",
            "ChatHistory_ChatsRemoved_other",
            "SaveToDownloadCount_zero",
            "SaveToDownloadCount_one",
            "SaveToDownloadCount_two",
            "SaveToDownloadCount_few",
            "SaveToDownloadCount_many",
            "SaveToDownloadCount_other"
        )
