...
# also important for performance. Also lists the fork's own attribute names.
cdef set special_attrs = set(dir(type) +                        # Special Python attributes
                             ["_chaquopy_j_klass",              # Chaquopy class attributes
                              "_chaquopy_reflector",            #
                              "_chaquopy_j_class_access_all",   # fork
...
# --- fork: performance timing instrumentation --------------------------------
...
# --- fork: sentinels and modifier name sets -----------------------------------
...
# --- fork: chain / null-safety wrappers ----------------------------------------
...
# --- fork: property getter/setter lookup plan cache ----------------------------
#
# The fork extends the Java-side Reflector with getPropertyGetters/getPropertySetters, and
...
# --- fork: instance-level property alias descriptor ----------------------------
