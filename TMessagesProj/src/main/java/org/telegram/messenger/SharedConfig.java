...
//    public static int saveToGalleryFlags;
    ...
    public static class ProxyInfo {
        ...
        public static ProxyInfo fromUrl(String url) {
            ...
            final String secret = lnk.getQueryParameter("secret");
            return new ProxyInfo(ProxySettings.builder()
                    .setAddress(lnk.getQueryParameter("server"))
                    .setPort(Utilities.parseInt(lnk.getQueryParameter("port")))
                    .setUser(lnk.getQueryParameter("user"))
                    .setPassword(lnk.getQueryParameter("pass"))
                    .setSecret(secret)
