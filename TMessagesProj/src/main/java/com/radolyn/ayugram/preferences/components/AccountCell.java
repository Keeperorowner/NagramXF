...
/**
 * Cell used for the "Global Settings" entry in the ghost mode account selector dropdown.
 * Ported from ayuGram's {@code com.radolyn.ayugram.preferences.components.AccountCell}.
 */
