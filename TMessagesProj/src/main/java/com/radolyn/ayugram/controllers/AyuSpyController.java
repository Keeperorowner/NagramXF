...
/**
 * Records read receipts for outgoing messages, mirroring ayuGram's {@code AyuSpyController}.
 * Captures outbox reads ({@link #onOutboxRead}) and content reads ({@link #onContentsRead}),
 * persisting the observed read time on {@link AyuQueues#spyQueue}, gated by {@code NaConfig.saveReadDate}.
 */
